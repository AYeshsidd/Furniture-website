...
<div className="flex space-x-9 my-8 ">  
   ...
   <Link href="./sidebar" className="hover:scale-125 hover:-translate-y-3 transition-all">
   <Image src={"/vector.png"} width={23.33} height={18.67} alt="vector man" className=""/>
   </Link>

   <Link href="./comparision" className="hover:scale-125 hover:-translate-y-3 transition-all"> <Image src={"/search.png"} width={22.17} height={22.17} alt="vector man" className=""/>
   </Link>
   <Link href="./singalProduct" className="hover:scale-125 hover:-translate-y-3 transition-all">
    <Image src={"/heart.png"} width={23.33} height={20.81} alt="vector man" className=""/>
    </Link>
 
  <Link href="./cart" className="hover:scale-125 hover:-translate-y-3 transition-all">
